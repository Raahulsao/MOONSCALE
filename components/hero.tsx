...
export function Hero() {
  const buttonNew = (
    <Button asChild className="rounded-full px-6 text-black" style={{ backgroundColor: "#7B68EE" }}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center justify-center py-14 sm:py-20">
          <div className="mb-5 flex items-center gap-2">
            <Image src="icons/logo.png" alt="Moon Scale logo" width={32} height={32} className="h-8 w-8" />
          ...
          <h1 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            ...
            <span className="block drop-shadow-[0_0_20px_rgba(123,104,238,0.35)]" style={{ color: "#7B68EE" }}>
              3D ANIMATION
            </span>
          ...
          {/* Phone grid mimic */}
          <div className="mt-25 grid w-full gap-4 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 h-auto py-50 overflow-hidden">
            {phoneData.map((p, i) => {

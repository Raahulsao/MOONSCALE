...
const defaultContent: FooterContent = {
  ...
  copyright: "© 2025 — Moon Scale International Uk",
}
    ...
    <section className="text-white">
      ...
      <div className="container mx-auto px-4 pt-12 sm:pt-16">
        <div className="flex justify-center">
          <Button
            asChild
            className="rounded-full px-6 py-2 text-sm font-medium text-black shadow-[0_0_20px_rgba(123,104,238,0.35)]"
      ...
      <div className="container mx-auto px-4 py-12 sm:py-16">
        <Card className="relative overflow-hidden rounded-3xl liquid-glass p-6 sm:p-10">
          <div className="relative grid items-center gap-8 md:grid-cols-2 py-[230px]">
            {/* Left copy */}
            <div>
              <p className="mb-2 text-[11px] tracking-widest" style={{ color: "#7B68EE" }}>
        ...
        <div className="container mx-auto px-4 py-10">
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                <Image src="icons/logo.png" alt="Moon Scale logo" width={24} height={24} className="h-12 w-12" />
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      aria-label="Follow moon scale on Twitter"
                    >
                      X/Twitter
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-purple-300"
                      aria-label="Subscribe to moon scale on YouTube"
                    >
                      YouTube
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-purple-300"
                      aria-label="Follow moon scale on Instagram"
                    >
                      Instagram
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-purple-300"
                      aria-label="Follow moon scale on Threads"
                    >
                      Threads
                    </a>
                  </li>
          ...
          <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 text-xs text-neutral-500 sm:flex-row">
            ...
            <div className="flex items-center gap-6">
              <Link href="/revisions" className="hover:text-purple-300">
                Revision Policy
              </Link>
              <Link href="/t&c" className="hover:text-purple-300">
                Terms & Conditions
              </Link>
            </div>
          </div>
